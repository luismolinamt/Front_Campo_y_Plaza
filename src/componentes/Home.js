   ...
   <div className="flex-1 bg-white">
      <div className="py-16 sm:py-24 xl:mx-auto xl:max-w-7xl xl:px-8">
        <div className="px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8 xl:px-0">
          <h2 className="text-2xl font-bold tracking-tight text-gray-900">Compra por categoría</h2>
          <a href="#" className="hidden text-sm font-semibold text-blue-600 hover:text-indigo-500 sm:block">
        ...
        <div className="mt-6 px-4 sm:hidden">
          <a href="#" className="block text-sm font-semibold text-blue-600 hover:text-indigo-500">
          Todas las categorías
            <span aria-hidden="true"> &rarr;</span>
          </a>
        </div>
          ...
          {productos.map((product) => (
            <div key={product.id}>
              ...
              <div className="mt-6">
                ...
                >
                  Agregar al carrito de compras<span className="sr-only">, {product.name}</span>
                </a>
              </div>
            </div>
          ))}
